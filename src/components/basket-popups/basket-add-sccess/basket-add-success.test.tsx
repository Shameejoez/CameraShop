...
import BasketAddSucess from './basket-add-sucess';
...
describe('basket-add-delet-item', () => {
  it('shuld render basket-add-success', () => {
    render(
      <Provider store={store}>
        <MemoryRouter>
          <BasketAddSucess isActive='is-active' onClickSetBasketSucess={jest.fn}/>
        </MemoryRouter>
      </Provider>);

    expect(screen.getByTestId('basket-add-success')).toBeInTheDocument();
