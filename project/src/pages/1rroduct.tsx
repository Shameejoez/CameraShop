...
import StarsRating from '../components/1stars-rating/1stars-rating';
...
import ProductTabs from '../components/roduct-tabs/1product-tabs';
import ReviewList from '../components/Review/1review-list/1review-list';
