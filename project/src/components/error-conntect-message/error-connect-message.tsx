...
function ErrorConnectMessage ({isVisible}: ErrorConnectMessageProps):JSX.Element {
  ...
  return (
    ReactDOM.createPortal (
      <div className={`modal modal--narrow ${isVisible ? 'is-active' : ''}`} >
        <div className="modal__wrapper">
          ...
          <div className="modal__content" >
            ...
            <div className="modal__buttons">
              <button className="btn btn--purple modal__btn modal__btn--fit-width" type="button" onClick={refreshPage}>Перезагрузить страницу
              </button>
            </div>
          </div>
        </div>
